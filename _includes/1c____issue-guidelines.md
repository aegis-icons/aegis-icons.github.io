...
2. **Check that icon you're about to request doesn't already exist by using search on this site** or opened / closed in the GitHub issues.
   - Icon packs aren't continuously updated in every new icon ([see the pack releases](https://github.com/aegis-icons/aegis-icons/releases)). Icons created before the next icon pack update are downloadable on this website.
